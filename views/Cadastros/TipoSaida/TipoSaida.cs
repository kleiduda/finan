...
namespace views
{
    public partial class TipoSaida : Form
    {
        ...
        private void TipoSaida_Load(object sender, EventArgs e)
        {
            if (lblID.Text != "novo")
            {
                IsNew = false;
        ...
        public void Edit()
        {
            ...
            dt = DoCadastros.TipoSaida_ListaPorID(int.Parse(lblID.Text));
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        DoCadastros.TipoSaida_Update(int.Parse(lblID.Text), txtCadastro.Text);
                    }
